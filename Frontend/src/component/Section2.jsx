                ...
                <div className='flex flex-wrap justify-center items-stretch gap-10 '>
                    <div className="flex flex-col  md:flex-row items-center   ">
                        <div className="relative flex items-center  m-10 md:mr-65  "> {/* Container for positioning the circle */}
                            <div className="absolute h-16 w-16 md:h-20 md:w-20 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] rounded-full bg-yellow-500 -left-8 md:-left-12 transform -translate-y-1/2 top-1/2 m1"></div> {/* Circle */}
                        ...
                        <div className="relative flex items-center "> {/* Container for positioning the circle */}
                            <div className="absolute h-16 w-16 md:h-20 md:w-20 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] rounded-full bg-green-500 md:-left-10 -left-8 transform -translate-y-1/2 top-1/2 m2"></div> {/* Circle */}
                    ...
                    <div className="flex flex-col  md:flex-row items-center ">
                        <div className="relative flex items-center  m-10 md:mr-65"> {/* Container for positioning the circle */}
                            <div className="absolute h-16 w-16 md:h-20 md:w-20 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] rounded-full bg-purple-600 -left-8 md:-left-10 transform -translate-y-1/2 top-1/2 m3"></div> {/* Circle */}
                        ...
                        <div className="relative flex items-center "> {/* Container for positioning the circle */}
                            <div className="absolute h-16 w-16 md:h-20 md:w-20 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] rounded-full bg-pink-600 md:-left-10 -left-8 transform -translate-y-1/2 top-1/2 m4"></div> {/* Circle */}
                    ...
                    <div className="flex flex-col  md:flex-row items-center ">
                        <div className="relative flex items-center  m-10 md:mr-65"> {/* Container for positioning the circle */}
                            <div className="absolute h-16 w-16 md:h-20 md:w-20 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] rounded-full bg-red-600 -left-8 md:-left-10 transform -translate-y-1/2 top-1/2 m5"></div> {/* Circle */}
                        ...
                        <div className="relative flex items-center "> {/* Container for positioning the circle */}
                            <div className="absolute h-16 w-16 md:h-20 md:w-20 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] rounded-full bg-blue-800 -left-8 md:-left-10 transform -translate-y-1/2 top-1/2 m6"></div> {/* Circle */}
