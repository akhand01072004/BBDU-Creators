...
export default function Projectdetails() {
 ...
 // const navigate = useNavigate();
  ...
  return (
    <>
    <div className='w-[90%] ml-6 h-full'>
      ...
      <div className='flex flex-row mt-6  text-blue-500'>
          <img src={project.projectImage} alt='Project' className='w-[55%]  object-cover  rounded-lg mb-2 ml-12' />
          <div className='text ml-[30%] min-h-96'>
            ...
            {project.githubRepo && <a href={project.githubRepo} className=" text-xl font-bold mb-6 text-blue-500 hover:underline">GitHub Repo</a>}<br></br>
            <Link to={`/UserPublicProfile/${project.email}`} className=" bg-blue-500 hover:bg-blue-700 text-white font-bold mt-5 py-2 px-4 rounded-full">
                View Profile
            </Link>
          <div>
          </div>
      ...
      <video src={`${project?.projectVideo}`} controls className='w-[40%] mx-12'></video>
